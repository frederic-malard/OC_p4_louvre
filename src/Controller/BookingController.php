...
class BookingController extends AbstractController
{
    ...
    public function index(Request $request, ObjectManager $manager, ReservationRepository $repository)
    {
        ...
        $reservationsMatching = $repository->getReservationsFromMail($mail);
